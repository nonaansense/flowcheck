...
def calc_earnings_iv_crush_risk(data: dict, trade: dict) -> dict:
    ...
    # Buying right before earnings = high crush risk
    if days_to_expiry and days_to_expiry <= 2:
        # Same-day or next-day expiry around earnings
        result["crush_risk"]         = "EXTREME"
        result["crush_emoji"]        = "🚨"
        result["crush_label"]        = "Expires during earnings — IV will crush 40-60% immediately after"
