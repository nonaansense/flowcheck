...
def handle_add(ticker: str, contracts_str: str, price_str: str,
    ...
    try:
        ...
        send_reply(
            ...
            "Example: /add FLNC 1 3.10 2026-05-27 11:00",
            reply_chat_id
        )
...
def handle_journal_help(reply_chat_id: str):
    lines = [
        ...
        "/entry TICKER STRIKE C/P EXPIRY CONTRACTS PRICE [DATE] [TIME]",
        "  Log now:   /entry FLNC 23 C 06/18/26 3 2.85",
        "  Retroactive: /entry FLNC 23 C 06/18/26 3 2.85 2026-05-27 10:34",
        "",
        "/exit TICKER PRICE [CONTRACTS] [DATE] [TIME]",
        "  Full exit: /exit FLNC 4.20 2026-05-27 13:15",
        "  Partial:   /exit FLNC 4.20 2 2026-05-27 13:15",
        "  Quick:     /exit FLNC 4.20  (uses current time)",
        "",
        "/add TICKER CONTRACTS PRICE [DATE] [TIME]",
        "  Add to position: /add FLNC 1 3.10 2026-05-27 11:00",
        "",
