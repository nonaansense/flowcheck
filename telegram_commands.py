...
def handle_journal_help(reply_chat_id: str):
    msg = chr(10).join([
        ...
        '  /sync HLIT 25 C 1 0.65 @rh_brok',
        '  Duplicate protection: tells you if already logged',
        '  At 4:05 PM ET: bot sends daily check-in with open positions',
        '  Add anything missing via /sync, then confirm',
        '',
        ...
        '    /spread AAPL dc 06/20/26 2 200 205 1.50',
        '',
        'SCREENSHOT LOGGING',
        ...
        '',
        'DAILY AUTOMATION',
        '  4:05 PM ET — position check-in (compare journal vs your broker)',
        '  4:10 PM ET — daily P&L summary (closed today + open unrealized)',
        '  4:02 PM ET — EOD option prices fetched for open positions',
        '',
        'WEB TABLE',
        '  /journal response includes link to full sortable table',
        '  Columns: Type, Contract, Last $, Open P&L (green/red)',
        '  Account filter tabs + sort toggle',
        '',
        'EDITING',
        '/edit TICKER [@ACCOUNT] FIELD VALUE',
