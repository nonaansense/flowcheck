...
def handle_help(reply_chat_id: str):
    msg = chr(10).join([
        ...
        '',
        'TRADE JOURNAL',
        '/journal [@ACCOUNT] — open trades with live P&L + web table',
        '/pnl [@ACCOUNT] — full P&L + pattern analysis',
        '/accounts — all accounts overview',
        '/export [@ACCOUNT] — CSV download for Excel',
...
def handle_journal_help(reply_chat_id: str):
    msg = chr(10).join([
        ...
        '  Screenshot:   send broker fill confirmation photo — auto-reads',
        '                account type + fill date/time from screen',
        '  Omitting date+time auto-fills current time with a warning',
        '',
        'LOGGING EXITS',
        '/exit TICKER PRICE [CONTRACTS] [DATE] [TIME]',
        '  Full exit now:    /exit BE 18.50',
        ...
        '',
        'VIEWING',
        '/journal [@ACCOUNT] — open trades: live P&L, stop, target',
        '  /journal           all accounts',
        '  /journal @RH_Trad  IRA account only',
        '  Response includes link to full web table + CSV download',
        '/pnl [@ACCOUNT] — P&L + pattern analysis (unlocks at 10+ trades)',
        '  /pnl           all accounts',
        '  /pnl @RH_Brok  Margin account only',
        '/accounts — all accounts with P&L summary',
        '/export [@ACCOUNT] — CSV for Excel',
        '  /export @RH_Trad   IRA trades → flowcheck_journal_rh_trad.csv',
        '/debrief — AI analysis of your journal (needs 3+ closed trades)',
        '',
        'EDITING',
        '/edit TICKER [@ACCOUNT] FIELD VALUE',
        '  Specify @ACCOUNT when same ticker exists in multiple accounts',
        '  /edit BE entry_time 10:34AM',
        '  /edit BE @RH_Trad entry_time 10:34AM',
        '  /edit BE @RH_Brok note Entered on VWAP bounce',
        ...
        '  Win rate by tag appears in /pnl after 10+ trades',
        '',
        'ACCOUNTS',
        '/account add ID NAME SIZE',
        ...
        '  Tag entries: add @ID to /entry or send screenshot',
        '  Auto-detected from screenshot account label (Traditional IRA etc)',
        '',
        'TIME FORMAT — all times ET',
        '  10:34AM   2:30PM   10:34   14:30   10AM   2PM',
        '',
        'WEB VIEW',
        '  /journal response includes link to full table with account tabs',
