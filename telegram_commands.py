...
def handle_journal_help(reply_chat_id: str):
    msg = chr(10).join([
        ...
        '  Shows last price + unrealized P&L (EOD auto-update or /refresh)',
        '  /journal           all accounts',
        '  /journal @rh_trad  IRA only',
        '/refresh — fetch current option prices for all open positions',
        '  Updates journal and web table immediately on demand',
        '/pnl [@ACCOUNT] — P&L + pattern + slippage + fees (10+ trades)',
