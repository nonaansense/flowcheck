...
def score_trade(trade: dict, data: dict, pattern: dict = None) -> dict:
    ...
    move_a   = data.get('move_analysis') or {}
    mkt_data = data.get('market') or {}
...
- Required move to ITM: {move_a.get('required_pct','N/A')}%
- Expected range by expiry: ±{move_a.get('expected_pct','N/A')}%
- Assessment: {move_a.get('assessment','Not calculated')} {move_a.get('move_emoji','')}
