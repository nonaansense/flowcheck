        ...
        if r.status_code == 200:
            ...
            if isinstance(articles, list):
                ...
                for a in articles:
                    ...
                    # Strict rule: ticker must appear in headline (not just summary)
                    if ticker.lower() not in headline:
                        continue

                    # Skip if ticker is not in first 60 chars of headline
                    # e.g. "Salesforce, Dell Headline..." — Dell at position 14 = OK
                    # e.g. "AXT Inc. (AXTI) outlook... Dell mentioned later" = SKIP
