...
| `trade_journal.py` | Comprehensive trade journal with analytics |
...
/stats — win rate statistics (option P&L based)
/find TICKER — today's alerts for ticker
/sentiment TICKER — price, news, flow, insider, analyst
...
TRADE JOURNAL
/journal — open trades with live P&L + stop/target
/pnl — full P&L, analytics, pattern analysis
/journal_help — all journal logging commands
