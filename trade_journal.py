...
def get_accounts() -> dict:
    """Return all configured accounts from dedicated Supabase key."""
    return load_accounts()

def add_account(account_id: str, name: str, size: float) -> dict:
    """Add or update an account — saved to dedicated Supabase key."""
    ...
    print(f"[JOURNAL] Account saved to Supabase: [{account_id}] {name}")
